...
Built as a reactsy (loosely) logic exploration using DOM for class CCS 32.

- Check progression through commit navigation
- End result creates a random card everysecond; clicking on it stops this behaviour, clicking again generates a new card and resumes behaviour
- Creates card using Card constructor function; includes test with jest
